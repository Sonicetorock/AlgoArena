...
//   return (
//     <div className="w-3/5 m-8 overflow-x-auto shadow-xl rounded-lg">
//       <div className="m-4">
//         <input
//           type="text"
...
//               <tr key={problem._id} className="border-b hover:bg-gray-200 hover:text-black">
...
const ListOfProblems = () => {
  ...
  const filteredProblems = problems
    .filter((problem) => {
      ...
      if (selectedFilter === "solved") return problem.isSolved;
      if (selectedFilter === "attempted") return problem.isAttempted;
