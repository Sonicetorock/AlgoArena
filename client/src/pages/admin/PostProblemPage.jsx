...
//         demoTestCases: [{ input: '', output: '', explanation: '' }],
//         constraintTime: 0,
//         constraintMemory: 0,
//     });
//     // const [testcaseInputs, setTestcaseInputs] = useState(['']);
//     // const [demoTestcaseInputs, setDemoTestcaseInputs] = useState(['']);
...
//     const handleArrayChangeType1 = (setter, index, value) => {
//         setter(prev => {
//             const newArr = [...prev];
//             newArr[index] = value;
//             return newArr;
//         });
//     };
//     const handleArrayChangeType2 = (index, field, value, arrayName) => {
...
//     const handleArrayAddType1 = (setter) => {
//         setter(prev => [...prev, '']);
//     };
//     const handleArrayAddType2 = (arrayName) => {
//         setFormData(prevState => ({ ...prevState, [arrayName]: [...prevState[arrayName], { input: '', output: '', explanation: '' }] }));
//     };

//     const handleArrayRemoveType1 = (setter, index) => {
//         setter(prev => prev.filter((_, i) => i !== index));
//     };
//     const handleArrayRemoveType2 = (index, arrayName) => {
//         setFormData(prevState => {
//             const newArray = [...prevState[arrayName]];
...
//         e.preventDefault();
//         try {
//             // await axios.post('/api/admin/problems', formData, {
...
//                                         type="text"
//                                         value={tag}
//                                         onChange={(e) => handleArrayChangeType1(setTagsInputs, index, e.target.value)}
//                                         className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
//                                     />
//                                     <button
//                                         type="button"
//                                         onClick={() => handleArrayRemoveType1(setTagsInputs, index)}
...
//                             <button
//                                 type="button"
//                                 onClick={() => handleArrayAddType1(setTagsInputs)}
...
//                                         type="text"
//                                         value={hint}
//                                         onChange={(e) => handleArrayChangeType1(setHintsInputs, index, e.target.value)}
//                                         className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
//                                     />
//                                     <button
//                                         type="button"
//                                         onClick={() => handleArrayRemoveType1(setHintsInputs, index)}
//                                         className="px-3 py-1 bg-red-500 text-white rounded-md hover:bg-red-700"
//                                     >
//                                         Remove
//                                     </button>
...
//                             <button
//                                 type="button"
//                                 onClick={() => handleArrayAddType1(setHintsInputs)}
//                                 className="mt-2 px-4 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-700"
//                                 >
//                                 Add Hint
//                             </button>
...
//                                         onChange={(e) => handleArrayChangeType2(index, 'input', e.target.value, 'testcases')}
//                                         placeholder="Input"
//                                         required
//                                         className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
//                                     />
...
//                                         onChange={(e) => handleArrayChangeType2(index, 'output', e.target.value, 'testcases')}
//                                         placeholder="Output"
//                                         required
//                                         className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm mt-1"
//                                     />
//                                     <button
//                                         type="button"
//                                         onClick={() => handleArrayRemoveType2(index, 'testcases')}
...
//                             <button
//                                 type="button"
//                                 onClick={() => handleArrayAddType2('testcases')}
//                                 className="mt-2 px-4 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-700"
//                             >
//                                 Add Test Case
//                             </button>
...
//                             {formData.demoTestCases.map((demoTestcase, index) => (
//                                 <div key={index} className="space-y-2 mt-1">
//                                     <input
//                                         type="text"
//                                         value={demoTestcase.input}
//                                         onChange={(e) => handleArrayChangeType2(index, 'input', e.target.value, 'demoTestCases')}
//                                         placeholder="Input"
//                                         required
//                                         className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
//                                     />
...
//                                         onChange={(e) => handleArrayChangeType2(index, 'output', e.target.value, 'demoTestCases')}
//                                         placeholder="Output"
//                                         required
//                                         className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm mt-1"
//                                     />
...
//                                         onChange={(e) => handleArrayChangeType2(index, 'explanation', e.target.value, 'demoTestCases')}
//                                         placeholder="Explanation (Optional)"
//                                         className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm mt-1"
//                                     />
//                                     <button
//                                         type="button"
//                                         onClick={() => handleArrayRemoveType2(index, 'demoTestCases')}
//                                         className="px-3 py-1 bg-red-500 text-white rounded-md hover:bg-red-700 mt-1"
//                                     >
//                                         Remove
//                                     </button>
...
//                             <button
//                                 type="button"
//                                 onClick={() => handleArrayAddType2('demoTestCases')}
//                                 className="mt-2 px-4 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-700"
//                             >
//                                 Add Demo Test Case
//                             </button>
...
const PostProblemPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success('Problem posted successfully');
            navigate('/admin/dashboard'); //this causes the rendering of adminDashboard
        } catch (error) {
            toast.error('Error posting problem');
            console.error('Error posting problem:', error);
        }
