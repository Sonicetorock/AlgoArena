      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <div className="flex justify-evenly gap-2 mb-6">
          ...
          <div className="hover:-translate-y-2 group bg-neutral-50 duration-500 w-48 h-44 flex text-neutral-600 flex-col justify-center items-center relative rounded-xl overflow-hidden shadow-md">
            ...
            {/* <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="absolute blur z-10 fill-rose-300 duration-500 group-hover:blur-none group-hover:scale-105">
